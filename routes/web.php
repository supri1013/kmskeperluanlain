...
Route::group(['middleware' => ['auth','CheckRole:visitor']], function () {
...
Route::get('/kategori/forum/{jenis}', 'ForumdiskusiController@jenisforum')->name('jenis.forum');
...
Route::get('/kategori/wiki/{jenis}', 'WikiController@jeniswiki')->name('jenis.wiki');
