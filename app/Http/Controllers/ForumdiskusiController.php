...
class ForumdiskusiController extends Controller
{
    ...
    public function jenisforum(Jenis $jenis)
    {
        $data_list = $jenis->forumdiskusi()->get();
        $jenis = Jenis::withCount('forumdiskusi')->get();
        $data_forum = Forumdiskusi::latest()->get()->random(3);
    ...
    {
        $jenis = Jenis::all();
        return view ('user.forumdiskusi.tambah-forum',compact('jenis'));
    }
    ...
    public function forumsayaedit($id)
    {
        ...
        $jenis = Jenis::all();
        return view ('user.forumdiskusi.edit-forum',compact('forumdiskusi','jenis'));
    }
    ...
    //KELOLA ADMIN-------------------------------------------------------------------//
     ...
     {
         $jenis = Jenis::all();
         return view ('admin.kelforum.tambah-forumdiskusi',compact('jenis'));
     }
    ...
    public function editforum($id)
    {
        ...
        $jenis = Jenis::all();
        return view ('admin.kelforum.edit-forumdiskusi', compact('forum','jenis'));
    }
